...
\begin{center}
	...
	\vspace{5mm} \\
	\textbf{Watch the full video:} \href{https://kevysilb.github.io/AM238/hw4.html#solution-1}{here}.
\end{center}
:::
...
\begin{align}
	dX &= -X^3 dt - \tau Y dt + \sigma dW_1 \\
	dY &= -\tau Y dt + \sigma dW_2
\end{align}
...
therefore the conditional expectation $$\mathbb{E}\{Y|X\} = \frac{1}{2}e^{-\tau t}$$
