...
::: {layout="[1, 1]" fig-cap="" fig-pos="H"}
  ![$\tau = 0.02$](hw3_files/media/question1c_0.02.png){#fig-image1 width="105%"}
  
  ![$\tau = 1.0$](hw3_files/media/question1c_1.0.png){#fig-image2 width="105%"}
:::
...
![Histogram of relative frequencies of $10^6$ samples using the MRG32k3a algorithm](hw3_files/media/question2.png){#fig-image3 width="75%"}
:::
...
```
::: {layout="[1]" fig-cap="" fig-pos="H"}
![The pdf](hw3_files/media/question3c.png){#fig-image4 width="75%"}
:::
...
::: {layout="[1]" fig-cap="" fig-pos="H"}
![5 sample paths of the SDE for $\Delta = 10^{-4}$ for $t \in [0, 5]$](hw3_files/media/question3e.png){#fig-image4 width="75%"}
:::
...
\begin{center}
	\includegraphics[width=0.6\linewidth]{hw3_files/media/question3partF1.png}
	\vspace{5mm}
	\includegraphics[width=0.6\linewidth]{hw3_files/media/question3partF2.png}
	\vspace{5mm}
	\includegraphics[width=0.6\linewidth]{hw3_files/media/question3partF3.png}
	\vspace{5mm} \\
	\textbf{Watch the full video:} \href{https://kevysilb.github.io/AM238/hw3.html#solution-9}{here}.
\end{center}
:::

::: {.content-visible when-format="html"}
<video width="700" autoplay loop muted>
  <source src="hw3_files/media/question3partF.mp4" type="video/mp4">
